...
# hyperparameters
batch_size = 64 # independept sequences to process in parallel
...
encode = lambda s: [stoi[c] for c in s] # encoer: string to list of ints
...
class GPTLanguageModel(nn.Module):
    ...
    def generate(self, idx, max_new_tokens):
        ...
        for _ in range(max_new_tokens):
            ...
            idx = torch.cat((idx, idx_cond), dim=1) #(B, T + 1)
        return idx
